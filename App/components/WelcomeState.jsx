...
export default function WelcomeState({ onFullSystemScan, onCustomScan }) {
  return (
    <div className="w-full max-w-xl text-center flex flex-col items-center justify-center relative">
      <img
        src={logoImage}
        width="430"
        height="430"
        className="size-[430px] grayscale-100 opacity-5 absolute z-2"
      />
      ...
      <p className="mx-auto mt-3 max-w-md text-sm opacity-70">
        ...
        your projects with AI-powered summaries.
      </p>
      <div className="mt-7 flex justify-center gap-2">
        <button
          type="button"
          className="btn btn-primary rounded-full px-8 z-5"
        ...
        <button
          type="button"
          className="btn btn-primary btn-outline rounded-full px-8 z-5"
